...
This skill outlines the standard operating procedure for releasing a new version of the **NHR AI Developer Assistant** plugin.
...
1. **Main Plugin File**: Update the `Version:` header in `nhrrob-ai-assistant.php`.
2. **Readme File**: 
...
1. Commit the version bump:
   ```bash
   git add nhrrob-ai-assistant.php readme.txt
